...
interface TeamService{
    ...
    fun requestTeamDelete(@Path("teamName") teamName:String):Call<Int>
    ...
    fun addTeamMember(@Body teamMember:MutableList<String>, @Path("teamName") teamName:String):Call<Int>
}